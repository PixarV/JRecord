...
public class TstLineBin {
    ...
    private static String copyBookDTAR020 = "DTAR020.cbl";
    ...
    public void setUp() throws Exception {
        ...
        LayoutDetail copyBook =
                copybookInt.loadCopyBook(
                        this.getClass().getClassLoader().getResource(copyBookName).getFile(),
...
//            throw new AssertionError("Size Error: " + msg);
    ...
    private AbstractLine defMainframeRec() throws Exception {
        LayoutDetail dtar0020 =
                copybookInt.loadCopyBook(
                        this.getClass().getClassLoader().getResource(copyBookDTAR020).getFile(),
