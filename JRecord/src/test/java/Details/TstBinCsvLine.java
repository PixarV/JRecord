...
public class TstBinCsvLine extends TestCase {
    ...
    private RecordEditorXmlLoader recordEditorXmlLoader = new RecordEditorXmlLoader();

    private String layoutFile = "zzBinCsv.Xml";
    ...
    public AbstractLine buildLine() throws Exception {
        ...
        if (layout == null) {
            layout = recordEditorXmlLoader.loadCopyBook(this.getClass().getClassLoader().getResource(layoutFile).getFile(),
                    0, 0, "", 0, 0, new TextLog())
                    .asLayoutDetail();
